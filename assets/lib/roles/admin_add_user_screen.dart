...
class _AdminAddUserScreenState extends State<AdminAddUserScreen>
  ...
  // 🔐 Huquqlar/funksiyalar xaritasi — endi FAQAT cheklangan "admin" roli
  // uchun emas, balki YANGI SUPERADMIN yaratilganda ham ishlatiladi: shu
  // orqali "admin" (yoki superAdmin) o'ziga tobe superAdmin uchun barcha
  // funksiyalarni birma-bir yoqib/o'chirib bera oladi.
  //
  // Ikki guruhga bo'lingan:
  //  1) Amal huquqlari — bitta ekran ichidagi aniq amal (masalan o'chirish).
  //  2) Bo'lim huquqlari ("access...") — chapdagi menyudagi butun bir
  //     bo'limga (Dashboard, Xonalar, Rol boshqaruvi va h.k.) kirish
  //     huquqi. Ruxsat o'chirilsa, o'sha bo'lim admin ekranida qulflanadi.
  final Map<String, bool> permissions = {
    // Amal huquqlari
    'canEditRooms': false,
    'canDeleteUsers': false,
    'canExportExcel': false,
    // Bo'lim (funksiya) huquqlari
    'accessDashboard': false,
    'accessUmumiyRoyxat': false,
    'accessTalabalar': false,
    'accessXonalar': false,
    'accessMurojaatlar': false,
    'accessRolBoshqaruvi': false,
    'accessTolovCheklari': false,
    'accessImtiyozlar': false,
    'accessSozlamalar': false,
  };

  // Rol tanlanganda huquqlar uchun oqilona standart qiymatlarni qo'yadi:
  // superAdmin — odatda TO'LIQ boshqaruv huquqiga ega bo'lgani uchun
  // hammasi yoqilgan holda boshlanadi (kerak bo'lsa admin ba'zilarini
  // o'chirib qo'yishi mumkin); cheklangan "admin" esa xavfsizlik uchun
  // hammasi o'chirilgan holda boshlanadi (kerakli huquqlar qo'lda yoqiladi).
  void _applyDefaultPermissions(String role) {
    if (role == 'superAdmin') {
  ...
  final List<_HostelOption> _hostels = const [
    _HostelOption('boys', "O'g'il bolalar", Icons.person_rounded, _C.teal),
    _HostelOption('girls', 'Qiz bolalar', Icons.person_rounded, _C.pink),
  ];
  ...
  void _createUser() async {
    ...
    try {
      ...
      final success = await AuthService.addUserByAdmin(
        ...
        // 🔐 YANGILANDI: endi huquqlar ("permissions") nafaqat cheklangan
        // "admin" roli uchun, balki yangi "superAdmin" yaratilganda ham
        // saqlanadi — shu orqali unga qaysi funksiyalar yoqilgan/o'chirilgan
        // bo'lishi Firestore'ga yoziladi va UserModel.hasPermission() orqali
        // haqiqatda ishlatiladi (qarang: user_model.dart).
        extraData: (_selectedRole == 'admin' || _selectedRole == 'superAdmin')
                              ...
                              child: Form(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                                ...
                                                child: _RoleTile(
                                                  ...
                                                  onTap: () {
                                                    ...
                                                    setState(() {
                                                      ...
                                                      _selectedRole = r.value;
                                                      // Rol haqiqatan
                                                      // o'zgarganda huquqlar
                                                      // shu rol uchun mos
                                                      // standart holatga
                                                      // qaytariladi (allaqachon
                                                      // shu rol tanlangan
                                                      // bo'lsa, admin qo'lda
                                                      // sozlagan huquqlar
                                                      // bekor qilinmaydi).
                                                      if (roleChanged) {
                                                        _applyDefaultPermissions(
                                                            r.value);
                                                      }
                                                    });
                                                  },
                                    ...
                                    // 🔐 HUQUQLAR / FUNKSIYALAR PANELI
                                    // Endi ikkala rol uchun ham ko'rinadi:
                                    // cheklangan "admin" uchun ANIQ va
                                    // yangi "superAdmin" uchun ham — shu
                                    // orqali super adminning barcha
                                    // funksiyalarini birma-bir yoqish yoki
                                    // o'chirish mumkin bo'ladi.
                                    AnimatedSize(
                                      duration:
                                          const Duration(milliseconds: 300),
                                      curve: Curves.easeOut,
                                                ...
                                                children: [
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Text(
                                                      _selectedRole ==
                                                              'superAdmin'
                                                          ? "Kerak bo'lmagan funksiyalarni o'chirib qo'yishingiz mumkin — qolganlari standart bo'yicha yoqilgan."
                                                          : "Ushbu foydalanuvchiga qaysi funksiyalarga ruxsat berishni tanlang.",
                                                      style: TextStyle(
                                                        color: _C.muted,
                                                        fontSize: 12,
                                                      ),
