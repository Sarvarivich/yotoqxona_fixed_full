...
class _MudirScreenState extends State<MudirScreen> {
  ...
  final List<_NavItem> _navItems = const [
    ...
    _NavItem('Ariza yuborganlar', Icons.assignment_rounded,
        Icons.assignment_outlined, _C.purple),
    ...
    _NavItem('Xonaga biriktirish', Icons.meeting_room_rounded,
        Icons.meeting_room_outlined, _C.mint),
  ...
  void initState() {
    ...
    _tabs.addAll([
      ...
      MudirArizalarScreen(user: widget.user),
      TalabalarList(
        isAdmin: false,
        hostel: widget.user.hostel ?? 'boys',
      ),
      ...
      // ✅ Laravel backend orqali ishlaydigan xonaga biriktirish.
  ...
  bool get _ownsAppBar => _selectedIndex == 5;
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                // 🛠️ "To'lov cheklari" ro'yxatda 5-o'rinda (index 4) turibdi
                // ("Dashboard, Talabalar ro'yxati, Xonalar, Murojaatlar,
                // To'lov cheklari, Sozlamalar"), lekin bildirishnoma
                // nuqtachasi noto'g'ri index 3 ("Murojaatlar")ga bog'liq
                // bo'lib qolgan edi.
