...
// qiz bolalar) boshqarishi kerak bo'lgani uchun, ularning Firestore'
// dagi bitta `hostel` qiymati ushbu tekshiruvdan chetlab o'tiladi.
// ✅ Shuningdek, Firestore'da "hostel" maydoni umuman to'ldirilmagan
// (null) foydalanuvchilar (masalan ikkala yotoqxonaga xizmat
// qiluvchi moliyachi) ham "global" hisoblanadi va chetlab o'tiladi.
      ...
      if (!mounted) return;
      setState(() => _isLoading = false); // AuthService ichida xatolik xabari ko'rsatiladi
      ...
      // (u yerda Dashboard, Talabalar, Xonalar, Murojaatlar,
      // Bildirishnomalar, To'lovlar, Hisobotlar va Sozlamalar bir joyda).
      // ✅ Yo'naltirish endi Firestore'dagi saqlangan `user.hostel`
      // qiymati emas, balki admin/superAdmin AYNAN QAYSI tugmani
      // bosgani (`widget.hostel`) asosida amalga oshiriladi. Aks
      // holda hostel-tekshiruvi chetlab o'tilgan admin baribir
      // noto'g'ri (masalan har doim o'zining saqlangan hostel'iga
      // mos) panelga tushib qolar edi.
