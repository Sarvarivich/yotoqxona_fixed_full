...
class DefaultFirebaseOptions {
  ...
  // Windows va Linux uchun alohida Firebase "app" ro'yxatdan o'tkazilmagan,
  // shuning uchun FlutterFire CLI odatiy amaliyotiga ko'ra "web" konfiguratsiyasi
  // qayta ishlatiladi (firebase_core desktop implementatsiyasi REST asosida
  // ishlaydi va web apiKey/appId bilan ishlashga moslashgan).
