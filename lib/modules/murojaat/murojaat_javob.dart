  ...
  Future<void> _submitResponse() async {
    ...
    try {
      final body = <String, dynamic>{
        ...
        if (respondedByRole != null) 'responded_by_role': respondedByRole,
        if (_selectedStatus == ComplaintStatus.resolved)
          'resolved_at': DateTime.now().toUtc().toIso8601String(),
      };

      // Murojaatni Firebase emas, Laravel API orqali yangilaymiz.
      await ComplaintApiService().updateComplaint(
        widget.complaint.id,
        body,
      );
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("Javob muvaffaqiyatli yuborildi"),
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text("Javobni yuborishda xatolik: $e"),
          backgroundColor: _LC.coral,
          behavior: SnackBarBehavior.floating,
        ),
      );
