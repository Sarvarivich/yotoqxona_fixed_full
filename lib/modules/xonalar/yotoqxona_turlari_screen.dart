...
class YotoqxonaTurlariScreen extends StatefulWidget {
  final bool isAdmin;
  final bool? canEdit;
  ...
  @override
  State<YotoqxonaTurlariScreen> createState() => _YotoqxonaTurlariScreenState();
}

class _YotoqxonaTurlariScreenState extends State<YotoqxonaTurlariScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      final roomsRaw = await _api.getRooms();
      final studentsRaw = await _api.getStudents();

      final parsedRooms = <RoomModel>[];
      for (final r in roomsRaw) {
        if (r is Map) {
          parsedRooms.add(RoomModel.fromJson(Map<String, dynamic>.from(r)));
        }
      }
  ...
  String _normalizeAssignmentType(String raw) {
