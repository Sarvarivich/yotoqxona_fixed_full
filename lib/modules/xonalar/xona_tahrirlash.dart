  ...
  Future<void> _updateRoom() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        final capacity = int.tryParse(_capacityController.text) ?? widget.room.capacity;

        await _apiService.updateRoom(widget.room.id, {
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text(
          ...
          "Diqqat! Bu xonadagi talabalar ham xonadan chiqariladi!",
        ),
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              try {
                await _apiService.deleteRoom(widget.room.id);
            ...
            child: Text("Chiqarish / O'chirish"),
          ),
        ],
      ),
    );
